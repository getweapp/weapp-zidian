...
Page({
  ...
  loadData:function(){
    ...
    if('pinyin'==that.data.searchType){
        url ='https://api.getweapp.com/vendor/xhzd/querypy?'+'&word='+word+'&dtype=&page='+page+'&isjijie=1&isxiangjie=1&pagesize=10'
    }else if('bushou'==that.data.searchType){
        url ='https://api.getweapp.com/vendor/xhzd/querybs?'+'&word='+word+'&dtype=&page='+page+'&isjijie=1&isxiangjie=1&pagesize=10'
